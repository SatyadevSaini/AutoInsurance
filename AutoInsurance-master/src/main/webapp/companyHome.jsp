...
<html>
    <head>
        ...
        <meta name="author" content="Richa Mishra &Abhishek Pandey"/>
    ...
    <body>
        <nav class="navbar navbar-expand-sm sticky-top bg-light">
            ...
            <div class="collapse navbar-collapse " id="collapsibleNavbar"  >
              ...
              <div >
                  <a class="text-danger h5 mr-3" href="tel:+91-7007645854">CALL US TODAY: +91-7007645854</a>
              </div>
            </div>
        </nav>
        ...
        <footer class="bg-dark p-4">
          <p class="text-white">
            Design by <a href="https://www.incapp.in" target="_blank">RICHA & ABHISHEK</a> &copy; Rights reserved
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Social Media: 
            <a href="https://facebook.com/smart.abhi.5817"><i class="fab fa-facebook"></i></a>
            &nbsp;
            <a href="https://instagram.com/_r.i.c.h.a_m.i.s.h.r.a"><i class="fab fa-instagram"></i></a>
          </p>
        </footer>
