            ...
            <div class="collapse navbar-collapse " id="collapsibleNavbar"  >
              <ul class="navbar-nav mx-auto ">
                ...
                <li class="nav-item">
                	...
                	<label class="nav-link"> Welcome: <b>${adminName}</b> </label>
                </li>
                <li class="nav-item">
        ...
        <section class='container p-4'>
        	<c:forEach items="${companies}" var="company">
				<div class='p-2'>
    				...
    				<img src="getImage?email=${company.email}" height="30px"/>
    				Name: ${company.name}  
    				Email: ${company.email}
    				Phone: ${company.phone}
    				...
    				<a href='changeStatus?email=${company.email}&status=Active' class='btn btn-success'>Accept</a>
    				<a href='changeStatus?email=${company.email}&status=Deactive' class='btn btn-danger'>Decline</a>
    				</p>
    			</div>
			</c:forEach>
        </section>
