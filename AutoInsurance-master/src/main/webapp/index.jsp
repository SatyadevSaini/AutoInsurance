...
<html>
    <head>
        ...
        <meta name="keywords" content="best Insurance comapny in Greater Gurgram"/>
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-sm sticky-top bg-light">
			...
			<div class="collapse navbar-collapse " id="collapsibleNavbar">
				...
				<div>
					<a class="text-danger h5 mr-3" href="tel:+91-8882193090">CALL US
						TODAY: +91-8882193090</a>
				</div>
			</div>
		</nav>
		</c:if>
